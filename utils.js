...
export async function saveBudget(event, password) {
...
export async function createNewCategoriesFromParams(params, password) {
...
export async function getCurrentBudget(params, password) {
    const budgetDB = new PouchDB("budgets");
...
export async function getCategories(params, password) {
    const categoriesDB = new PouchDB("categories");
...
export async function decryptAllDocs(rows, password) {
